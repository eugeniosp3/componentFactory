...
function Card({title, header, bodyText, titleColor, headerColor, bodyTextColor, imgSource}) {
  return (
    <div
      className="h-80 first:rounded-l-xl last:rounded-r-xl xxs:max-md:first:rounded-t-xl xxs:max-md:last:rounded-b-xl 
      xxs:w-11/12 xs:w-11/12 sm:w-11/12 md:w-11/12 lg:w-5/6 xl:w-3/5 2xl:w-11/12
